  ...
  return (
    <main className="flex h-screen w-screen justify-center overflow-hidden bg-black font-mono text-white">
      ...
      >
        ...
        {/* Scrollable Content */}
        <div ref={scrollContainerRef} className="flex-1 overflow-y-auto scrollbar-hide px-3">
          
          {/* Token Header Card */}
          <div className="mt-2 p-4 rounded-2xl bg-zinc-900/50 border border-zinc-800/50">
            <div className="flex items-start gap-4">
              ...
              <div className="w-16 h-16 rounded-xl overflow-hidden bg-zinc-800 flex-shrink-0">
                {tokenLogoUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-xl font-bold text-purple-500">
              ...
              <div className="flex-1 min-w-0">
                ...
                <h1 className="text-lg font-bold truncate">{tokenName}</h1>
          ...
          {/* Current Miner Card */}
          {hasMiner && (
            <div className="mt-3 p-4 rounded-2xl bg-gradient-to-br from-purple-500/10 to-purple-500/5 border border-purple-500/20">
              <div className="flex items-center gap-4">
                {/* Miner Avatar */}
                <button
                  onClick={() => minerFid && viewProfile(minerFid)}
                  disabled={!minerFid}
                  className={minerFid ? "cursor-pointer flex-shrink-0" : "cursor-default flex-shrink-0"}
                >
                  <Avatar className="h-14 w-14 ring-2 ring-purple-500/50">
                    <AvatarImage src={minerAvatarUrl} alt={minerDisplayName} />
                    <AvatarFallback className="bg-zinc-800 text-white text-base">
                ...
                {/* Miner Info */}
                <div className="flex-1 min-w-0">
                  <div className="text-xs text-purple-400 font-medium mb-0.5">Currently Mining</div>
                  <button
                    onClick={() => minerFid && viewProfile(minerFid)}
                    disabled={!minerFid}
                    className={minerFid ? "cursor-pointer" : "cursor-default"}
                  >
                    <div className={`text-sm font-semibold text-white truncate ${minerFid ? "hover:text-purple-400" : ""}`}>
                      {minerDisplayName}
                    </div>
                  </button>
                ...
                {isCurrentUserMiner && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-purple-500 hover:bg-purple-600 transition-colors text-xs font-medium text-white"
                  >
                ...
                <div className="text-right">
                  ...
                  <div className="flex items-center justify-end gap-1.5 text-base font-semibold">
                    ...
                    {tokenLogoUrl ? (
                      ...
                      <span className="w-4 h-4 rounded-full bg-purple-500 flex items-center justify-center text-[8px] text-white font-bold">
                        {tokenSymbol.slice(0, 2)}
                      </span>
                    )}
        ...
        >
          ...
          <div className="flex items-center h-14">
            ...
            <div className="flex items-center h-full">
              ...
              <button
                ...
                className={cn(
                  "w-14 h-14 rounded-r-full flex items-center justify-center transition-all border-2",
                  mineResult === "success"
                    ? "bg-green-500 border-green-400"
                    : mineResult === "failure"
                    ? "bg-zinc-700 border-zinc-600"
                    : "bg-purple-500 hover:bg-purple-600 border-purple-400 active:scale-95",
              ...
              >
                {mineResult === "success" ? (
                  ...
                  <span className="inline-flex items-center gap-0.5 text-black text-sm">
                    <span className="animate-bounce-dot-1">•</span>
                    <span className="animate-bounce-dot-2">•</span>
                    <span className="animate-bounce-dot-3">•</span>
                  </span>
          ...
          <Link
            href="/explore"
            className="w-14 h-14 rounded-full bg-purple-500 hover:bg-purple-600 flex items-center justify-center shadow-lg shadow-purple-500/30 border-2 border-purple-400 transition-all active:scale-95"
          >
